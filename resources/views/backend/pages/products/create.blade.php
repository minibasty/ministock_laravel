            ...
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('product_name') ? 'is-invalid' :'' }}"
                  id="product_name" name="product_name" placeholder="ป้อนชื่อสินค้า" value="{{old('product_name')}}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('product_qty') ? 'is-invalid' :'' }}"
                  id="product_qty" name="product_qty" placeholder="ป้อนจำนวนชิ้น" value="{{old('product_qty')}}">
