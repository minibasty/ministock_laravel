          ...
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('product_name') ? 'is-invalid' :'' }}"
                  id="product_name" name="product_name" placeholder="ป้อนชื่อสินค้า" value="{{$product->product_name}}">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="product_detail" name="product_detail"
                  style="height: 100px">{{$product->product_detail}}</textarea>
              </div>

              <div class="form-group">
                <label for="product_barcode">บาร์โค้ด</label>
                <input type="text" class="form-control  {{ $errors->has('product_barcode') ? 'is-invalid' :'' }}"
                  id="product_barcode" name="product_barcode" placeholder="ป้อนบาร์โค้ด"
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('product_qty') ? 'is-invalid' :'' }}"
                  id="product_qty" name="product_qty" placeholder="ป้อนจำนวนชิ้น" value="{{$product->product_qty}}">
                <span class="help-block text-danger"><small>{{ $errors->first('product_qty') }}</small></span>
              </div>

              <div class="form-group">
                <label for="product_price">ราคา</label>
                <input type="text" class="form-control {{ $errors->has('product_price') ? 'is-invalid' :'' }}"
                  id="product_price" name="product_price" placeholder="ป้อนราคา" length="7"
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('product_category') ? 'is-invalid' :'' }}"
                  id="product_category" name="product_category" placeholder="ป้อนหมวดหมู่"
